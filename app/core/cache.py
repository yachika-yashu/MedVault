...
CACHE_COLLECTION = "medvault_semantic_cache"
SIMILARITY_THRESHOLD = 0.95
EXACT_CACHE_PREFIX = "medvault:query"
...
# # Connects to Qdrant and creates the semantic cache collection if it doesn't already exist. For    
# detailed explanation of the `init_cache_db` function refer to the `code_understanding.md` file. 
...
def init_cache_db():
    ...
    if CACHE_COLLECTION not in existing_names:

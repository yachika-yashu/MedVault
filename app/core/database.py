...
# explanation of this file in code_understanding.md under [init_db() [Relational Database Initialization]]
...
engine_kwargs = {}
# PostgreSQL connections should be pooled and pre-pinged so stale sockets are recycled instead of causing first-request failures after deploys or restarts. 

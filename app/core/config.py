...
# All functions explanations can be found in code_understanding.md
...
# =============================================================================
ASSETS_DIR = "assets/images" #name of the folder where generated images are stored
...
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://medvault:change_me_local@localhost:5432/medvault")
CHECKPOINTS_DB_URL = os.getenv("CHECKPOINTS_DB_URL", "data/checkpoints.db") # Persistent SQLite store for LangGraph state
...
ENABLE_DOCS = os.getenv("ENABLE_DOCS", "true").strip().lower() == "true"  # if you want to disable docs, set it to false set false in production for security   
...
RERANKER_MODEL = "cross-encoder/ms-marco-MiniLM-L-6-v2"  # Specified cross-encoder
RERANK_TOP_K = 10  # Candidates to consider for reranking
RERANK_FINAL_K = 4 # Final top results to return
